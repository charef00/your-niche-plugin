...
function download_and_unzip() {
    $zip_file = 'https://your-niche.com/file.zip'; // URL of the file to download
...
function delete_custom_folder() {
    $folder_path = get_home_path() . 'your-folder-name'; // Change 'your-folder-name' to the actual folder name
...
register_deactivation_hook(__FILE__, function() {
    // Code to delete the downloaded folder
});
